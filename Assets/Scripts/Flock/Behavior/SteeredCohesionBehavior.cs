...
[CreateAssetMenu(menuName = "FlockBehavior/SteeredCohesionBehavior")] //criar uma aba para criar o scriptable object
public class SteeredCohesionBehavior : FilteredFlockBehavior
{ //coesao -> objetos/flocks/agents andarem "juntos" / "agruparem" em "harmonia" (mais "suave", para evitar "flick" / agents "tremendo") 
    //public
    public float agentSmoothTime; //tempo para "suavizar" o movimento //default 0.5

    //private
    private Vector2 currentVelocity; //velocidade atual do behavior
    ...
    public override Vector2 CalculateMove(FlockAgent flockAgent, List<Transform> nearObjects, FlockManager flockManager) //funcao que calcula o movimento de um individuo (baseado tambem nos objetos e/ou "vizinhos" ao seu redor)
    {
        ...
        cohesionMove = Vector2.SmoothDamp(flockAgent.transform.up, cohesionMove, ref currentVelocity, agentSmoothTime); //suavizar o movimento do objeto
